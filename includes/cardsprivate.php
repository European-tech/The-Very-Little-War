...
if($tuto['niveaututo'] < 10) {
    ...
    elseif($tuto['niveaututo'] == 9) {
        ...
        if(preg_match("#Visiteur[0-9]+#",$_SESSION['login'])) {
            ...
            $contenuTuto = $contenuTuto.'<form method="post" name="finirTuto" action="tutoriel.php" style="display: block;margin: 0 auto;text-align: center;" >'.csrfField().submit(['titre' => 'Finir le tutoriel', 'form' => 'finirTuto', 'nom' => 'finir']).'</form>';
        }
