...
$adversaire = dbFetchOne($base, 'SELECT tempsPrecedent FROM autre WHERE login=?', 's', $_POST['joueurAAttaquer']);
$nbsecondesAdverse = time() - $adversaire['tempsPrecedent'];// On calcule la différence de secondes
$depotAdverse = dbFetchOne($base, 'SELECT depot FROM constructions WHERE login=?', 's', $_POST['joueurAAttaquer']);

dbExecute($base, 'UPDATE autre SET tempsPrecedent=? WHERE login=?', 'is', time(), $_POST['joueurAAttaquer']);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////ENERGIE
