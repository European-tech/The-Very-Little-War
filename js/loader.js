// Google Charts loader — local copy
// Source: https://www.gstatic.com/charts/loader.js
// Downloaded: 2026-03-07
// TODO: Replace with CDN + SRI hash:
//   <script src="https://www.gstatic.com/charts/loader.js" integrity="sha384-[hash]" crossorigin="anonymous"></script>
(function () {
  var aa = "\n//# sourceURL=",
  ...
  Z.Xa &&
    ...
    (Z.rc = function (a) {
      if ((a = Z.Fa(a)) && a in Z.j.F)
        for (var c in Z.j.F[a]) if (!Z.Tc(c) && !Z.wb(c)) return !1;
      return !0;
    }),
    (Z.Ab = function (a) {
      if (a in Z.j.X) {
        ...
        void 0 === c
          ? Z.Wb
            ...
            : Z.Za
              ...
              : Z.zd(a)
          : d.write(
              '<script type="text/javascript">' + Z.kd(c) + "\x3c/script>",
            );
        return !0;
      }
      return !1;
  ...
  Z.Dg = function (a, c) {
    ...
    if (!e) {
      ...
      if (g) {
        ...
        if (
          Z.global.$gwtExport &&
          Z.global.$gwtExport.$jscomp &&
          !Z.global.$gwtExport.$jscomp.transpile
        )
          throw Error(
            'The transpiler did not properly export the "transpile" method. $gwtExport: ' +
              JSON.stringify(Z.global.$gwtExport),
          );
    ...
    for (var e = Math.max(a.length, c.length), f = 0; 0 == d && f < e; f++) {
      ...
      do {
        ...
        d =
          ...
          Z.b.ra(0 == g[2].length, 0 == h[2].length) ||
          Z.b.ra(g[2], h[2]);
        g = g[3];
        h = h[3];
      } while (0 == d);
    ...
    for (var c = [], d = 0; d < arguments.length; d++) {
      ...
      if (Z.isArray(e))
        for (var f = 0; f < e.length; f += 8192)
          for (
            var g = Z.f.Ic.apply(null, Z.f.slice(e, f, f + 8192)), h = 0;
            h < g.length;
            h++
          )
            c.push(g[h]);
    ...
    if (c)
      if ("undefined" === typeof a.onload) {
        ...
        a.onreadystatechange = function () {
          d ||
            (a.readyState && a.readyState !== K
              ? google.a.c.window.setTimeout(a.onreadystatechange, 100)
              : ((d = !0),
      ...
      var nb = function (c) {
        ...
        if (e) {
          ...
          D
            ...
            : google.a.c.Fb[e]
              ? ((f = google.a.c.Fb[e]), (e = google.a.c.i.third_party_gen))
              : (e = google.a.c.Z ? h : T ? m : l);
          f = e
            .replace($a, g)
            .replace(bb, n)
            .replace("{language}", T)
        ...
        h = function (a) {
          ...
          google.a.c.R[m]
            ? (google.a.c.log("Already loaded " + m),
              google.a.c.window.setTimeout(l, 0))
            : ((google.a.c.R[m] = !0),
              (m = f
  ...
  google.a.c.load = function (a, c) {
    if (google.a.c.S)
      ...
      if (null == d)
        ((e = function () {
          var d =
              Z.N("google.charts.loader.publicLoad") ||
              Z.N("google.charts.versionSpecific.load"),
            e =
              Z.N("google.charts.loader.publicSetOnLoadCallback") ||
              Z.N("google.charts.versionSpecific.setOnLoadCallback");
          d(a, c);
          e(f);
        }),
          google.a.c.ea
        ...
        google.visualization.CssPath = google.a.c.i.css_prefix
          .replace($a, google.a.c.i.prefix)
          .replace(bb, google.a.c.I);
        google.a.c.window = window;
